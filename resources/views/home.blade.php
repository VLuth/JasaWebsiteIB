...
<body>
  ...
  <div class="hero_area">
    <div class="bg-box">
      <img src="{{asset('assets/carousell.png')}}" alt="">
    </div>
              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    <h1>
                      Selamat Datang di IB Digital 
                    </h1>
                    <p>
                      Kami adalah solusi terbaik untuk kebutuhan digital Anda. Dengan keahlian <br>dalam desain 
                      dan pengembangan website, 
                      kami membantu bisnis Anda tampil <br> profesional, menarik, dan kompetitif di era digital. 
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn1">
                        Order Now
        ...
        <div class="row grid">
          ...
          <div class="col-sm-6 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{asset('feane/images')}}/f2.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Burger
          ...
          <div class="col-sm-6 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{asset('feane/images')}}/f3.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pizza
          ...
          <div class="col-sm-6 col-lg-4 all pasta">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{asset('feane/images')}}/f4.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pasta
